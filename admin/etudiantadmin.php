...
$sql2 = "SELECT Nom, Prénom, Email, Mdp FROM utilisateur where User_role='etudiant' LIMIT $limit OFFSET $offset";
$result2 = $pdo->query($sql2);
$sql_count = "SELECT COUNT(*) AS count FROM utilisateur where User_role ='etudiant'";
            ...
            <table class="table table-striped table-hover">
                ...
                <?php while ($row = $result2->fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <td>
                        ...
                        <a href="deleteetudiant.php?email=<?php echo $row["Email"]; ?>" onclick="return confirm('Êtes-vous sûr de bien vouloir supprimer cet étudiant?');" class="delete"><i class="material-icons" data-toggle="tooltip" title="supprimer">&#xE872;</i></a>
                    </td>
                    </tr><?php } ?>
